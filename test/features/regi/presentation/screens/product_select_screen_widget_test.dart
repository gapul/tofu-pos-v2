...
/// 商品選択画面のスモーク（仕様書 §6.1.2 / §9.2）。
void main() {
  testWidgets('ProductSelectScreen 商品ボタンとカートパネルが出る', (tester) async {
    ...
    // タイトル。
    expect(find.text('商品選択'), findsOneWidget);
    // 商品名（テスト両方）。
    expect(find.text('揚げ豆腐'), findsAtLeastNWidgets(1));
    expect(find.text('湯豆腐'), findsAtLeastNWidgets(1));
  });
}
